 ...
 */
final class Version20190902111414 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE compte ADD partenaire_id INT NOT NULL, ADD createur_id INT NOT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_CFF6526073A201E5 ON compte (createur_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE compte DROP FOREIGN KEY FK_CFF6526073A201E5');
        $this->addSql('DROP INDEX IDX_CFF6526098DE13AC ON compte');
        $this->addSql('DROP INDEX IDX_CFF6526073A201E5 ON compte');
        $this->addSql('ALTER TABLE compte DROP partenaire_id, DROP createur_id');
    }
}
